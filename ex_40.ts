...
let album4 = myAlbum2("abida Parveen", "Raqs_E_bismil", 55);
let album5 = myAlbum2("Mehdi Hassan", "Aman ki Asha",  78);
let album6 = myAlbum2("Nusrat Fateh Ali Khan", "The Emperor");
